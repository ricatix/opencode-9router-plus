...
const sourceFile = /^open-sse\/(?:providers\/registry\/(?:index|[^/]+)\.js|providers\/(?:index|schema)\.js|providers\/models\/(?:schema|helpers)\.js|config\/providerModels\.js|providers\/(?:thinkingLevels|capabilities)\.js)$/;
