...
export const apiCatalog: Record<string, ModelsDevProvider> = {
  openai: { id: "openai", name: "OpenAI", models: { "gpt-5.6-sol": { id: "gpt-5.6-sol", name: "GPT 5.6 Sol", reasoning_options: [{ type: "effort", values: ["none", "low", "medium", "high", "xhigh", "max"] }] } } },
...
export const modelCatalog: Record<string, ModelsDevModel> = {
  "openai/gpt-5.6-sol": { id: "openai/gpt-5.6-sol", name: "Model-only GPT" },
};
